...
(function CSSSetup(inModule, w, sym, S, defer, D) {
    ...
    return css
}(!this, self, Symbol.for('[[CSSModule]]'), sessionStorage, (self.requestIdleCallback && function (c) { return requestIdleCallback(c, { timeout: 2000 }) }) || (self.scheduler && scheduler.postTask && function (c) { return scheduler.postTask(c, { priority: 'background' }) }) || self.queueMicrotask || self.setImmediate || setTimeout, document))
