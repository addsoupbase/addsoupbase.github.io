(function (w, sym) {
    var inModule = !this
    // document.readyState === 'loading' && !inModule && document.write('<pre style="transform:scale(0);position:absolute">a</pre>')
    ...
    function main() {
        ...
        var get = document.getElementById.bind(document, 'addedStyleRules')
