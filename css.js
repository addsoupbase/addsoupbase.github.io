...
(function (w, sym) {
    ...
    function cssSetup(S, inModule) {
        ...
        var d = Object.defineProperty, script = document.currentScript; ''.startsWith || d(String.prototype, 'startsWith', { value: function (s, p) { return this.slice(p = p | 0, (s += '').length + p) === s } });[].find || d(Array.prototype, 'find', { value: function (c, t, m, z) { for (var i = 0, l = (m = this).length; i < l; ++i) { z = m[i]; if (c.call(t, z)) return z } } })
        // b = b && b.remove()
        var src
        ...
        function getDefaultStyleSheet() {
            return (document.getElementById(disambiguity) || function () {
