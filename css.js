...
(function CSSSetup(inModule, w, sym, S, defer, D) {
    ...
    if (sym in w || typeof w[id] === 'object') return w[sym]
    ...
    var toValue = function (parse) {
        ...
        function a(p, v) {
            var out = parse(p, v.replace(imp, ''))
            Object.defineProperties(out, proto)
            Object.defineProperty(out, 'length', { value: v.length })
            return out
        }
