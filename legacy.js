'use strict'
/*@cc_on !function(t){"use strict";t.Map=t.Map||function(){var t=new ActiveXObject("Scripting.Dictionary");return{keys:function(){return t.Keys()},values:function(){return t.Items()},entries:function(){for(var e=t.Keys(),n=t.Items(),i=[],r=0,u=e.length;r<u;++r)i.push([e[r],n[r]]);return i},get size(){return t.Count},clear:function(){t.RemoveAll()},set:function(e,n){t.Exists(e)&&t.Remove(e),t.Add(e,n)},get:function(e){return t.Item(e)},has:function(e){return t.Exists(e)},delete:function(e){t.Exists(e)&&t.Remove(e)}}},t.WeakMap=t.WeakMap||function(){var t=new ActiveXObject("Scripting.Dictionary");return{set:function(e,n){t.Add(e,n)},get:function(e){return t.Item(e)},has:function(e){return t.Exists(e)},delete:function(e){t.Exists(e)&&t.Remove(e)}}},t.Set=t.Set||function(){var t=new ActiveXObject("Scripting.Dictionary");return{keys:function(){return t.Items()},values:function(){return t.Items()},entries:function(){for(var e=t.Items(),n=[],i=0,r=e.length;i<r;++i)n.push([e[i],e[i]]);return n},add:function(e){t.Exists(e)&&t.Remove(e),t.Add(e,"")},has:function(e){return t.Exists(e)},delete:function(e){t.Exists(e)&&t.Remove(e)},clear:function(){t.RemoveAll()},get size(){return t.Count}}}}(window);@*/var globalThis=globalThis||window,reportError=reportError||function reportError(t){try{try{var e=new ErrorEvent('error',{message:t.message,error:t})}catch(_){e=document.createEvent('ErrorEvent')
XMLHttpRequest = XMLHttpRequest.bind(window,{mozAnon:true,mozSystem:true})
